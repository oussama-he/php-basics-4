      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/" class="rounded-md px-3 py-2 text-sm font-medium <?= isUrl(
                "/"
            )
                ? "bg-gray-900 text-white"
                : "text-gray-300 hover:bg-gray-700 hover:text-white" ?>" aria-current="page">Home</a>
            <a href="/about" class="rounded-md px-3 py-2 text-sm font-medium <?= isUrl(
                "/about"
            )
                ? "bg-gray-900 text-white"
                : "text-gray-300 hover:bg-gray-700 hover:text-white" ?>">About</a>
            <a href="/notes" class="rounded-md px-3 py-2 text-sm font-medium <?= isUrl(
                "/notes"
            )
                ? "bg-gray-900 text-white"
                : "text-gray-300 hover:bg-gray-700 hover:text-white" ?>">Notes</a>
            <a href="/contact" class="rounded-md px-3 py-2 text-sm font-medium <?= isUrl(
                "/contact"
            )
                ? "bg-gray-900 text-white"
